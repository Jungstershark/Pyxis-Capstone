"""
Step 5: Train YOLO model on Classroom dataset.

Based on prior learnings:
- y11s (small) is optimal for our dataset sizes
- 960px resolution is the sweet spot
...
# ----------------------------
# TRAIN: classroom_y11s_960
# ----------------------------
if __name__ == "__main__":
    experiments = [
        Experiment(run_name="classroom_y11s_960", model="yolo11s.pt", imgsz=960, batch=24),
        Experiment(run_name="classroom_y11n_960", model="yolo11n.pt", imgsz=960, batch=32),
    ]
