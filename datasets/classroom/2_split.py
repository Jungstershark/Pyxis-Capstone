"""
Step 2: Split raw_frames into train/val/test sets (70/20/10).
...
SOURCE_DIR = Path(__file__).resolve().parent / "raw_frames"
OUTPUT_DIR = Path(__file__).resolve().parent / "split"
