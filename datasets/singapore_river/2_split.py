...
# Add data_processing to path so we can import the shared utilities
REPO_ROOT = Path(__file__).resolve().parents[2]
sys.path.insert(0, str(REPO_ROOT / "data_processing"))

from process import random_split_dataset

SOURCE_DIR = Path(__file__).resolve().parent / "1_frames_3fps"
OUTPUT_DIR = Path(__file__).resolve().parent / "2_frames_3fps_split"
...
if __name__ == "__main__":
    ...
    # Pre-create labels_auto directories for step 3 (autolabel)
