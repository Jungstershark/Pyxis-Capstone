"""
Step 6 v2: Benchmark v2 retrained models on GOLD TEST set.

Usage:
    cd Pyxis-Capstone/datasets/internet_scraped
    python 6_evaluate_v2.py
"""
...
OUT_CSV = SCRIPT_DIR / "6_test_benchmark_v2.csv"

RUNS = [
    ("is_v2_y11s_960",  "5_weights/is_v2_y11s_960/best.pt",  960),
    ("is_v2_y11m_960",  "5_weights/is_v2_y11m_960/best.pt",  960),
    ("is_v2_y11s_1280", "5_weights/is_v2_y11s_1280/best.pt", 1280),
]
