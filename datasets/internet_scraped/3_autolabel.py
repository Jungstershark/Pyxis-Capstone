...
Reads:
    2_frames_2fps_split/images/{train, val, test}

Writes:
    2_frames_2fps_split/labels_auto/{train, val, test}
...
DATASET_DIR = Path(__file__).resolve().parent / "2_frames_2fps_split"
...
if __name__ == "__main__":
    ...
    print("\nDone. Labels written to 2_frames_2fps_split/labels_auto/{train,val,test}")
